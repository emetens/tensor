...
hidden_nodes1 = 18
#hidden_nodes2 = int(round(hidden_nodes1 * mulitplier))
#hidden_nodes3 = int(round(hidden_nodes2 * mulitplier))
hidden_nodes2 = 27
hidden_nodes3 = 36
...
with tf.Session() as sess:
    ...
    for epoch in range(training_epochs): 
        ...
        if (epoch) % display_step == 0:
            ...
            if epoch > 0 and valid_accuracy > max(valid_accuracy_summary) and valid_accuracy > 0.96:
...
# sFind the predicted values, then use them to build a confusion matrix
